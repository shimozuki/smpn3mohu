			...
			<div class="d-flex flex-wrap align-items-stretch">
				<div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
					<div class="p-4 m-3">
						...
						<h5 class="text-dark font-weight-normal pt-5 mt-5"><center><img src="{{ asset('assets/img/unsplash/tuturi.png') }}" alt=""width=40%"></center><center><span class="font-weight-bold"> SMP Negri 3 Moyo Hulu</span></center></h5>
